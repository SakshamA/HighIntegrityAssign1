...
procedure ManualOperationExample is
   ...
   --    Heart.GetRate(Hrt, ActualHeartRate);
   --    Put (Item => ActualHeartRate);
   ...
   --    IsTachy := ICD.HasTachy(ICDSoftware);
   --    Put ("; Tachy = ");
   --    if IsTachy then
   --    	Put("True");
   --       Put (" ");
   --       Put(Item => ICDSoftware.NumBeatsPerTick);
   --    else
   --    	Put("False");
   --    end if; 
   --    if ICDSoftware.SendTachySignal = true then
   --       Put("Tachy Signal");
   --    end if;
   --    ICD.CheckVentFibril(ICDSoftware, Monitor, History);
   --    IsVentFibril := ICD.HasVentFibril(ICDSoftware);
   --    Put ("; VentFibril = ");
   --    if IsVentFibril then
   --    	Put("True");      	
   --    end if; 
   --    New_Line;
